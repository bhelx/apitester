...
class EndpointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endpoint" do
    assert_difference("Endpoint.count") do
      post endpoints_url, params: { endpoint: { name: @endpoint.name, source_code: @endpoint.source_code } }
    end
  ...
  test "should update endpoint" do
    patch endpoint_url(@endpoint), params: { endpoint: { name: @endpoint.name, source_code: @endpoint.source_code } }
